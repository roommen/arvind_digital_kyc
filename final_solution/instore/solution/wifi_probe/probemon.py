...
def build_packet_callback(time_fmt, logger, delimiter, mac_info, ssid, rssi):
	def packet_callback(packet):
		...
		#condition to write to db
		if fields[1] not in mac_ids:
			sql = "INSERT INTO WiFiTrack (MAC_ID,Manufacturer,Signal_Strength,Time_In,Time_Out) VALUES ('{}','{}',{},'{}','{}');".format(fields[1],fields[2],fields[3],fields[0],fields[0])
		else:
			sql = "UPDATE WiFiTrack SET Time_Out = '{}' WHERE MAC_ID = '{}';".format(fields[0],fields[1])
